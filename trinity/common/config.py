...
class FormatConfig:
    ...
    # for teacher-student distillation: optional key in raw_task for teacher hint (e.g. socratic reasoning)
    # when set, format_messages_teacher() can include raw_task[teacher_hint_key] in teacher prompt
